...
*/
	...
	* @returns int|false		The previous fetch mode
	*/
	...
	*/
	 ...
	 * Execute SQL 
	 *
	 * @param string|array $sql		SQL statement to execute, or possibly an array holding prepared statement ($sql[0] will hold sql text)
